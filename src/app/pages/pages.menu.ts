export const PAGES_MENU = [
  {
    ...
    children: [
      {
        path: 'virtualmarket',  // path for our page
        data: { // custom menu declaration
          menu: {
            title: 'Virtual Market', // menu title
      ...
      },
      {
        ...
        data: { // custom menu declaration
          menu: {
            title: 'Kelola Singkatan', // menu title
            icon: 'ion-android-home', // menu icon
            pathMatch: 'prefix', // use it if item children not displayed in menu
            selected: false,
            expanded: false,
      ...
      {
        path: 'fare-manager',  // path for our page
        data: { // custom menu declaration
          menu: {
            title: 'Kelola Tarif', // menu title
            icon: 'ion-android-home', // menu icon
            pathMatch: 'prefix', // use it if item children not displayed in menu
            selected: false,
            expanded: false,
